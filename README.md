...
- 박채원: 피그마와 코드를 활용해 사이트를 직접 구성하고 리뉴얼하는 경험을 했습니다. 익숙하지 않은 부분은 AI를 참고하며 맡은 역할을 끝까지 책임감 있게 수행했고, 해결이 어려운 문제는 팀원들과 적극적으로 소통하며 하나씩 풀어나갔습니다. 특히 팀원분들의 따뜻한 도움과 배려 덕분에 프로젝트를 끝까지 잘 마무리할 수 있었으며, 협업의 중요성을 다시 한번 느낄 수 있었습니다.
